...
THIS SCRIPT PLOTS THE HG SURFACE FLUXES AT THE AUSTRALIA (MAX) SCALE
FOR EACH MONTH

THE MAX SCALE IS BOX COVERING GRID BOXES:
    23 to 40 LATITUDINAL
    116 to 134 LONGITUDINAL
...
area = dataset1.variables['DXYP__DXYP'][:,23:40,116:134]            # Grid box surface area (m2)
...
anthro1 = (dataset1.variables['HG_SRCE__Hg0_an'][:,23:40,116:134])  # Hg0 anthro emissions (kg/month)
anthro2 = (dataset1.variables['HG_SRCE__Hg2_an'][:,23:40,116:134])  # Hg2 anthro emissions (kg/month)
anthro3 = (dataset1.variables['HG_SRCE__HgP_an'][:,23:40,116:134])  # HgP anthro emissions (kg/month)
anthro = (anthro1 + anthro2 + anthro3)                # anthro emissions (kg/month)
biomass = (dataset1.variables['HG_SRCE__Hg_bb'][:,23:40,116:134])   # biomass emissions (kg/month)
soil = (dataset1.variables['HG_SRCE__Hg_so'][:,23:40,116:134])      # soil emissions (kg/month)
geogenic = (dataset1.variables['HG_SRCE__Hg0_na'][:,23:40,116:134]) # land natural emissions (kg/month)
land_leg = (dataset1.variables['HG_SRCE__Hg0_ln'][:,23:40,116:134]) # land legacy/re- emissions (kg/month)
ocean = (dataset1.variables['HG_SRCE__Hg0_oc'][:,23:40,116:134])    # ocean net emissions (kg/month)
hg0_dd=(dataset1.variables['DRYD_FLX__Hg0df'][:,23:40,116:134])     # Hg0 dry deposition flux (molec/cm2/s)
hgII_1=(dataset1.variables['WETDLS_S__Hg2'][:,:,23:40,116:134])       # Loss of Hg2 in precipitation (kg/s)
hgII_2=(dataset1.variables['WETDCV_S__Hg2'][:,:,23:40,116:134])       # Rainout loss of tracer in convective updrafts (kg/s)
hgII_wd = (hgII_1 + hgII_2)                           # HgII wet deposition flux (kg/s)
snow=(dataset1.variables['HG_SRCE__Hg0_snow'][:,23:40,116:134])     # Snow emission of Hg (kg)
...
plt.title("Australian Hg surface fluxes (Maximum Boundary)", fontsize=15)
